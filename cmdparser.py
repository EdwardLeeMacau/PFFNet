...
parser.add_argument("--rb", default=24, type=int, help="number of residual blocks")
parser.add_argument("--batchsize", default=12, type=int, help="training batch size")
...
parser.add_argument("--multiscale", default=[1.0], type=float, nargs='*', help="Training with multiscale data.")
parser.add_argument("--multiscaleShuffle", default=False, action='store_true', help="If true, random scaling for each iteration")
...
parser.add_argument("--milestones", default=[100, 200], type=int, nargs='*', help="Which epoch to decay the learning rate")
...
parser.add_argument("--weight_decay", default=1e-5, type=float, help="The weight penalty in the training, Default: 1e-5")
...
parser.add_argument("--val_interval", default=100, type=int,  help="step to test the model performance")
parser.add_argument("--log_interval", default=100, type=int, help="interval per iterations to log the message")
# parser.add_argument("--grad_interval", default=0, type=int, help="interval per iterations to draw the gradient")
parser.add_argument("--save_interval", default=500, type=int, help="interval per iterations to save the model")
